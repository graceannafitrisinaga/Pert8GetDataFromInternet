...
/**
 * Kelas ini mengimplementasikan [RecyclerView] [ListAdapter] yang menggunakan Data Binding
 * untuk menyajikan data [List], termasuk menghitung perbedaan antara daftar.
 */
class PhotoGridAdapter :
    ...
    /**
     * Memungkinkan RecyclerView untuk menentukan item mana yang telah berubah ketika [List] dari [MarsPhoto] telah diperbarui.
     */
